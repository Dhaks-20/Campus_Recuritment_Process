...
<body>
    ...
    <div class="bg-img "><br>
     <h1 style="background-color: #f1f1f1;color:black;align-items:center;text-align:center; border-color: black;  "> APPLICATIONS FOR LG
     <button type="submit" class="btn btn-secondary" onclick="document.location='updatelg.html'" style="align-items: end;">Update Status</button>  </h1>   <br><br>
        <?php
$host='localhost';
$user='root';
$pass='';
